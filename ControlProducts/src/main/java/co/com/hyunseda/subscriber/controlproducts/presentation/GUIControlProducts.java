...
package co.com.hyunseda.subscriber.controlproducts.presentation;

import co.com.huynseda.microkernel.common.entities.Product;
import co.com.hyunseda.subscriber.controlproducts.infra.ISubscriber;
import co.com.hyunseda.subscriber.controlproducts.infra.RabbitListener;
 ...
 */
public class GUIControlProducts extends javax.swing.JFrame implements ISubscriber {

    DefaultListModel modelList;
    /**
     * Creates new form DeliveryOffice
     */
    public GUIControlProducts() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIControlProducts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUIControlProducts gui = new GUIControlProducts();
                gui.setSize(500, 400);
                gui.setVisible(true);
            }
        });
